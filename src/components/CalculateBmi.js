      ...
      {!bmiResult ? (
        <>
          ...
          <div style={{ display: "flex" }}>
           ...
           <span style={{minHeight : "30px"}}>{!weight && submited && weight<=0 && (
                  <span style={{ color: "black" }}>Please enter a valid weight</span>
                )}
             </span>   
            ...
            <span style={{minHeight : "30px"}}> {!height && submited && height<=0 && (
...
<FormControl
        ...
        <div className="mt-4">
          <p style={{ color: "black" }}>Your BMI is: {bmiResult} </p>
          <p style={{ color: "black" }}>You are currently: {status}</p>
          <p style={{ color: "black" }}>
            Your suggested weight range is between {low} and {high}
          </p>
          <div>
            <input
              type="submit"
