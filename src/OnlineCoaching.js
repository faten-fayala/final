...
<div>
    ...
    <p>loremjknvkjnnnnnnnnnkdnvkl,vlkd,v
    </p>
    <h2 className="program-description">What's Included</h2>
  
    <ul>
    <li> <AiOutlineCaretRight fill="#c79f5a" size="1.5em" /> List item 1</li>
    <li> <AiOutlineCaretRight fill="#c79f5a" size="1.5em" /> List item 2</li>
    <li> <AiOutlineCaretRight fill="#c79f5a" size="1.5em" /> List item 3</li>
    <li> <AiOutlineCaretRight fill="#c79f5a" size="1.5em"  /> List item 4</li>
</ul>
<FormControl
                variant="standard"
